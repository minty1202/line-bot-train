    ...
    events.each do |event|
      ...
      when Line::Bot::Event::Message
        ...
        when /.*(こんにちは|こんばんは|初めまして|はじめまして|おはよう).*/
          ...
          if user_train_info.delay?
            push =
              "運行状況かな？遅れてるみたい\n(> <)#{user_train_info.message}詳しくはこれをみてね！\nhttps://transit.yahoo.co.jp/traininfo/area/4/"
          else
            push =
            "運行状況かな？今のところ大丈夫そうかな\n(^^)\n詳しくはこれをみてね！\nhttps://transit.yahoo.co.jp/traininfo/area/4/"
          end
